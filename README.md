...
4. Open the extracted folder, right-click `PastyType.exe`, and select **Run as administrator**.
...
```
4. main.py also found inside the src folder along with other necessary files
...
[file-tag: code-generated-file-601e6f5b-eb73-41ab-8737-4c5ae113a564]

Below is the complete, formally revised content in a single Markdown block, ready for direct copy-pasting into your repository's `README.md` file. All casual phrasing has been replaced with precise, technical terminology while maintaining the original structural logic and troubleshooting steps.
...
1. Clone the repository:
   ```bash
   git clone [https://github.com/shivathelegend2006
/PastyType.git](https://github.com/shivathelegend2006
/PastyType.git)
   cd PastyType
